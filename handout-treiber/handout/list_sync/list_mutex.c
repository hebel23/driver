// list_mutex.c: konkurrierende Listenoperationen - Mutex
//
// Mechanismen:
...
static struct mutex rcul_list_lock;
...
// Prozess-Kontext haelt Mutex und sperrt Interrupts
// daher: auf gleicher CPU keine Probleme, wenn Interrupt rcul_add_messwert() aufruft
// aber: wenn CPU-1 im Prozess-Kontext Messwert hinzufügt und CPU-0 im Interrupt
//       Messwert hinzufuegt: Synchronisierungsproblem
//       ==> nicht sicher im SMP-Kontext !
...
// To-Do: Zugriff auf rcul_cycle erfolgt ganz ohne Synchronisierung
//
...
// Fehlerfall: mutex_lock() und local_irq_save() vertauscht
//   wenn Interrupts disabled werden ==> Atomarer Context,
//   aber: mutex_lock() kann schlafen ==> Deadlock
...
MODULE_DESCRIPTION("list_mutex --- konkurrierende Listenoperationen mit Mutex gesichert");
