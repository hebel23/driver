// list_not_safe.c: konkurrierende Listenoperationen - ohne Schutz
//
// Mechanismen:
...
struct rcul_messwert *rcul_mw;

LIST_HEAD (rcul_list_head);
...
static unsigned long long rcul_cycle = 1000ULL;  // [ms]
...
MODULE_DESCRIPTION("list_not_safe --- konkurrierende Listenoperationen ohne Synchronisierung");
